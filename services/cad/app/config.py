...
def load_settings() -> Settings:
    ...
    # 共享画法层：archdxf + dxfkit 的 src 目录（冒号分隔，缺省推导 skill dist 的 packages src）。
    ...
    if not drawlib_dir:
        ...
        default_drawlib = [
            repo / "skills" / "dist" / "aidxf" / "scripts" / "packages" / "archdxf" / "src",
            repo / "skills" / "dist" / "aidxf" / "scripts" / "packages" / "dxfkit" / "src",
        ]
