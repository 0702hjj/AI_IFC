...
| v0.10 | 中途预览 + DXF/webifc 编辑面 ✅（2026-08-18，分支 feat/v0.10-live-preview-dxf-edit，单 PR 收口，待提 PR）| W-0045 | run_script 成功推 viewer.staged SSE 事件 + 工具结果附 staging diff 摘要；dxf/webifc 自动刷新、xeokit 手动角标；dxf/webifc 分支挂 DesignPanel 全套编辑面 + dxf 选中定位脚本；aidxfv v1/v2 遗留删除 |
