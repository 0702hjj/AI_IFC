...
4. **Edit**: in the property panel, the whitelisted fields (Name / Description / Classification / FireRating / Comments) can be edited inline and saved as overrides; see [IFC Property Editing](/en/viewer/editing) for details.
