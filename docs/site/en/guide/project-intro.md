...
- **Leg 2: AI-generated CAD** (skill domain delivered; diff/editing API to build) — the `skills/aidxf/` skill (v1/v2 moved from `AI_CAD/skills/aidxfv*`) plus `services/cad` (peer of `services/ifc`).
