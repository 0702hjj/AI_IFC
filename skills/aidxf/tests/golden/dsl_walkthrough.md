...
| **G-05** | requirements 与骨架冲突（"bedroom faces_south" vs 北带卧室）无仲裁点 | 素材 A | **设计点**：冲突在 S1 由主 agent 裁决（调整骨架或标注 requirements 例外），rooms 不硬扛；走查记录进 references/orchestrator/skeleton.md（W5） | T06 记录 → W5 orchestrator |
