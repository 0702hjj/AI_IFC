...
拆分说明（W-0049 行数门控）：基础几何 helpers（_densify_ring/_block_polygons 等）
移入 derive_geom.py，本模块再导出保持 `from floorgeom.derive import ...` 契约。
"""
...
from .derive_geom import (  # noqa: F401 再导出保持原契约
    DEEP_ZONE_DEPTH_M, DIR_HALF_ANGLE_DEG,
    _dir_of_segment, _region_of_point, _densify_ring, _ring_to_polygon,
    _block_polygons, _polygon_area_sqm, _polygon_perimeter_m,
)
