...
拆分说明（W-0049 行数门控）：SchemaError 与轴网/几何解析 helpers 移入
normalize_geom.py，本模块保留环/边展开与 normalize_skeleton/normalize_rooms 入口，
并再导出 normalize_geom 全部符号保持 `from floorgeom.normalize import ...` 契约。
"""
...
from .normalize_geom import (  # noqa: F401 再导出保持原契约
    SchemaError,
    _snap, _resolve_axis, _resolve_point,
    _arc_discretize, _ring_to_vertices, _resolve_path_pts, _edge_outward_normal,
    _find_edge, _expand_recess_projection, _expand_path_with_segments,
)
